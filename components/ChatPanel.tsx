                ...
                <div className="space-y-2">
                  {[
                    ...
                    <button
                      ...
                      className="block w-full text-xs text-left px-3 py-2 bg-gray-50 rounded-lg hover:bg-gray-100 text-gray-500"
                    >
                      {suggestion}
                    </button>
                  ))}
          ...
          <div className="p-3 border-t border-gray-200">
            {!apiKey && (
              <button
                ...
                className="w-full py-2 mb-2 bg-amber-50 border border-amber-200 text-amber-600 rounded-lg text-xs font-medium"
              >
            ...
            <div className="flex gap-2">
              <input
                ...
                disabled={!apiKey}
                className="flex-1 px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-xs text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
              />
              <button
                onClick={handleSend}
